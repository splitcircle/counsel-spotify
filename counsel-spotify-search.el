;;; counsel-spotify-search.el --- Search things through the Spotify Search API
;;; -*- lexical-binding: t; -*-
...
(cl-defmethod counsel-spotify-parse-spotify-object (spotify-object type)
  "Parse a generic SPOTIFY-OBJECT of type TYPE."
...
(cl-defmethod counsel-spotify-parse-spotify-object (a-spotify-album-object (type (eql albums)))
  "Parse A-SPOTIFY-ALBUM-OBJECT of TYPE album."
...
(cl-defmethod counsel-spotify-parse-spotify-object (a-spotify-track-object (type (eql tracks)))
  "Parse A-SPOTIFY-TRACK-OBJECT of TYPE track."
